...
execute if data storage gm:storage temp.DIALOG.list.MAIN[0] run return run function gm:zprivate/dialog/spawn_gui/page/show_pages/format with storage gm:storage temp.DIALOG.list.MAIN[0]
